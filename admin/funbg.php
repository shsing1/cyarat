 ...
 * ============================================================================
 * Author: shsing1
 * Id: funbg.php 2009-11-27 12:00:00
*/
...
$ur_here = $sys_menu->get_ur_here(62);
...
/*------------------------------------------------------ */
	case 'list':
		...
		/* 模板賦值 */
		// $smarty->assign('action_link',  array('href' => 'funbg.php?act=add', 'text' => $_LANG['data_add']));
...
/*------------------------------------------------------ */
	case 'query':
		...
		make_json_result(	$smarty->fetch('funbg_list.htm'),
							'',
...
/*------------------------------------------------------ */
	case 'add':
		/* 模板賦值 */
		$smarty->assign('action_link',  array('href' => 'funbg.php?act=list', 'text' => $_LANG['data_list']));
...
/*------------------------------------------------------ */
	case 'insert':
		...
		// make_json_result('', $_LANG['data_add_succed'], array('url'=>'funbg.php?'.get_last_filter_url() ) );
		...
		make_json_result('', $_LANG['data_add_succed'], array(	'upload'=>'img',
																...
																'op'=>'add',
																'url'=>'funbg.php?'.get_last_filter_url() ));
...
/*------------------------------------------------------ */
	case 'edit':
		...
		$smarty->assign('action_link', array('text' => $_LANG['data_list'], 'href' => 'funbg.php?act=list'));
...
/*------------------------------------------------------ */
	case 'update':
		...
		//make_json_result('', $_LANG['data_upd_succed'], array('url'=>'funbg.php?'.get_last_filter_url() ) );
...
/*------------------------------------------------------ */
	case 'remove':
		...
		make_json_result('', $_LANG['data_del_succed'], array('url'=>'funbg.php?'.get_last_filter_url() ) );
...
/*------------------------------------------------------ */
	case 'batch':
		...
		make_json_result('', $_LANG['data_batch_succed'], array('url'=>'funbg.php?'.get_last_filter_url() ) );
...
/*------------------------------------------------------ */
	case 'upload_img':
		...
		make_json_result('', $_LANG['data_'.$op.'_succed'], array('url'=>'funbg.php?'.get_last_filter_url() ));
...
/*------------------------------------------------------ */
	case 'drop_img':
		...
		make_json_result('', $_LANG['img_del_succed'], array('url'=>'funbg.php?act=edit&id='.$id ) );
