...
//if (typeof $ != 'object')
//{
//  jAlert('Ajax object doesn\'t exists.');
//}
//
//if (typeof Utils != 'object')
//{
//  jAlert('Utils object doesn\'t exists.');
//}
...
listTable.gotoPageLast = function()
{
  if (this.filter.page < this.filter.page_count)
  {
    listTable.gotoPage(this.filter.page_count);
  }
}
...
listTable.listCallback = function(result, txt)
{
  ...
  else
  {
    try
    {
      ...
      this.filter.page_count = result.page_count;
    }
    catch (e)
    {
      alert(e.message);
...
listTable.getPageSize = function()
{
  ...
  if (pageSize)
  {
    ...
    document.cookie = "CHH[page_size]=" + ps + ";";
  }
}
