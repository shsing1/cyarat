 ...
 * ============================================================================
 * Author: shsing1
 * Id: custom_cat.php 2009-11-26 21:00:00
*/
...
$ur_here = $sys_menu->get_ur_here(33);
...
/*------------------------------------------------------ */
	case 'list':
		...
		/* 模板賦值 */
		$smarty->assign('action_link',  array('href' => 'custom_cat.php?act=add', 'text' => $_LANG['cat_add']));
		...
		/* 列表頁面 */
		assign_query_info();
		$smarty->display('custom_cat_list.htm');
...
/*------------------------------------------------------ */
	case 'add':
		/* 模板賦值 */
		$smarty->assign('action_link',  array('href' => 'custom_cat.php?act=list', 'text' => $_LANG['cat_list']));
		...
		/* 顯示頁面 */
		assign_query_info();
		$smarty->display('custom_cat_info.htm');
...
/*------------------------------------------------------ */
	case 'insert':	
		...
		make_json_result('', $_LANG['cat_add_succed'], array('url'=>'custom_cat.php'));
...
/*------------------------------------------------------ */
	case 'edit':
		...
		$smarty->assign('action_link', array('text' => $_LANG['cat_list'], 'href' => 'custom_cat.php?act=list'));
...
/*------------------------------------------------------ */
	case 'update':
		...
		make_json_result('', $_LANG['cat_upd_succed'], array('url'=>'custom_cat.php'));
...
/*------------------------------------------------------ */
	case 'remove':
		...
		make_json_result('', $_LANG['cat_del_succed'], array('url'=>'custom_cat.php'));
