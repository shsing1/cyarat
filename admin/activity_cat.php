 ...
 * ============================================================================
 * Author: shsing1
 * Id: activity_cat.php 2009-11-26 21:00:00
*/
...
/*------------------------------------------------------ */
	case 'list':
		...
		/* 模板賦值 */
		$smarty->assign('action_link',  array('href' => 'activity_cat.php?act=add', 'text' => $_LANG['cat_add']));
		...
		/* 列表頁面 */
		assign_query_info();
		$smarty->display('activity_cat_list.htm');
...
/*------------------------------------------------------ */
	case 'add':
		/* 模板賦值 */
		$smarty->assign('action_link',  array('href' => 'activity_cat.php?act=list', 'text' => $_LANG['cat_list']));
		...
		/* 顯示頁面 */
		assign_query_info();
		$smarty->display('activity_cat_info.htm');
...
/*------------------------------------------------------ */
	case 'edit':
		...
		$smarty->assign('action_link', array('text' => $_LANG['cat_list'], 'href' => 'activity_cat.php?act=list'));
...
/*------------------------------------------------------ */
	case 'remove':
		...
		make_json_result('', $_LANG['cat_del_succed'], array('url'=>'activity_cat.php'));
...
/*------------------------------------------------------ */
	case 'upload_img':
		...
		make_json_result('', $_LANG['cat_'.$op.'_succed'], array('url'=>'activity_cat.php'));
...
/*------------------------------------------------------ */
	case 'drop_img':
		...
		make_json_result('', $_LANG['img_del_succed'], array('url'=>'activity_cat.php?act=edit&cat_id='.$id ) );
