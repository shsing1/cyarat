 ...
 * ============================================================================
 * Author: shsing1
 * Id: privilege.php 2009-11-04 21:00:00
*/
...
//
///* 提示信息 */
//$_LANG['js_languages']['name_empty'] = '管理員用戶名不能為空!';
...
/* 提示信息 */
$_LANG['name_empty']		= '管理員用戶名不能為空!';
$_LANG['password_empty']	= '密碼不能為空!';
$_LANG['login_faild']		= '您輸入的帳號信息不正確。';
$_LANG['admin_disable']		= '此帳號尚未啟用。';
