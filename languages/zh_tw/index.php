...
/* 電子報訊息 */
$_LANG['epaper_title'] 				= '電子報訂閱';
$_LANG['button_epaper_add'] 		= '訂閱';
$_LANG['button_epaper_del'] 		= '退訂';
...
$_LANG['not_writable'] = '%s 目錄不可寫入，%s';
$_LANG['images_cannt_write']= '您將無法上傳任何圖片。';
$_LANG['fck_upload_cannt_write']= '您將無法通過編輯器上傳任何檔案。';
$_LANG['tpl_cannt_write'] = '您的網站將無法瀏覽。';
