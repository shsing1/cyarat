...
class page
{
    ...
    * config ,public
    */
    var $page_name = "page";//page標籤，用來控制url頁。比如說xxx.php?PB_page=2中的PB_page
    var $next_page = '>';//下一頁
    var $pre_page = '<';//上一頁
        ...
        for ($i = $begin; $i < $begin + $this->pagebarnum; $i++)
        {
            if ($i <= $this->totalpage)
            {
                if ($i != $this->nowindex)
                    ...
                    $return .= $this->_get_text('<span class="' . $nowindex_style . '">' . $i .
                        '</span>');
            }
            else
            {
    ...
    */
    ...
    {
        die('Error in file <b>' . __file__ . '</b> ,Function <b>' . $function .
            '()</b> :' . $errormsg);
    }
}
?>