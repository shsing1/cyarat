 ...
 * ============================================================================
 * Author: shsing1
 * Id: cls_captcha.php 2009-11-04 21:00:00
*/
...
class captcha
{
     ...
     * @return  bool
     */
    function init($folder = '', $width = 145, $height = 20)
    {
...
//print_r( $given);
    ...
    function generate_image($word = false)
    {
        ...
        else
        {
            ...
            /* 獲得驗證碼的高度和寬度 */
            $x = ($this->width - (imagefontwidth($font) * $letters)) / 2;
            $y = ($this->height - imagefontheight($font)) / 2;
            imagestring($img_org, $font, $x, $y, $word, $clr);
