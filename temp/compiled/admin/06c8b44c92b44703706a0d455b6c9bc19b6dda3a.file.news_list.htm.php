...
<?php /*%%SmartyHeaderCode:292252309b3f1ece91-41715924%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '06c8b44c92b44703706a0d455b6c9bc19b6dda3a' => 
    array (
  ...
  'nocache_hash' => '292252309b3f1ece91-41715924',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52309b3f285436_00269859',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52309b3f285436_00269859')) {function content_52309b3f285436_00269859($_smarty_tpl) {?><?php if ($_smarty_tpl->tpl_vars['full_page']->value){?>
...
<!-- 資料搜索 -->
<?php echo $_smarty_tpl->getSubTemplate ("news_search.htm", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
	...
	<div class="list-div" id="listDiv"> <?php }?>		
		<table cellpadding="3" cellspacing="1">
			<tr>
				...
				<th width="100"><a href="javascript:listTable.sort('date'); "><?php echo $_smarty_tpl->tpl_vars['lang']->value['lab_date'];?>
</a><?php echo $_smarty_tpl->tpl_vars['sort_date']->value;?>
</th>
                <th width="50"><a href="javascript:listTable.sort('is_hot'); ">HOT</a><?php echo $_smarty_tpl->tpl_vars['sort_is_hot']->value;?>
</th>
				...
				<th width="50" style="display:none;"><a href="javascript:listTable.sort('sort'); "><?php echo $_smarty_tpl->tpl_vars['lang']->value['lab_sort'];?>
...
" />
				...
				<td align="center"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data']->value['date'], ENT_QUOTES, 'UTF-8', true);?>
</td>
				<td align="center"><img src="templates/images/<?php if ($_smarty_tpl->tpl_vars['data']->value['is_hot']){?>yes<?php }else{ ?>no<?php }?>.gif" /></td>
				<td align="center"><img src="templates/images/<?php if ($_smarty_tpl->tpl_vars['data']->value['is_show']){?>yes<?php }else{ ?>no<?php }?>.gif" /></td>
				<td align="center" style="display:none;"><span ><?php echo $_smarty_tpl->tpl_vars['data']->value['sort'];?>
</span></td>
				<td align="center">
...
?>
			<tr>
				<td class="no-records" colspan="11"><?php echo $_smarty_tpl->tpl_vars['lang']->value['no_records'];?>
</td>
			</tr>
			<?php } ?>
		</table>
