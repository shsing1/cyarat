<?php /* Smarty version Smarty-3.1.14, created on 2013-09-11 16:56:26
         compiled from "D:\xampp\htdocs\cyarat\admin\templates\user_list.htm" */ ?>
<?php /*%%SmartyHeaderCode:154995230a0ba1cab85-63628421%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5b2b91ae3d376084f42f2897230c500aa27dfc81' => 
    array (
      0 => 'D:\\xampp\\htdocs\\cyarat\\admin\\templates\\user_list.htm',
      1 => 1260433665,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '154995230a0ba1cab85-63628421',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5230a0ba2a9631_31512472',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5230a0ba2a9631_31512472')) {function content_5230a0ba2a9631_31512472($_smarty_tpl) {?><?php if ($_smarty_tpl->tpl_vars['full_page']->value){?>
...
<!-- 資料搜索 -->
<?php echo $_smarty_tpl->getSubTemplate ("user_search.htm", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
	...
	<div class="list-div" id="listDiv"> <?php }?>		
		<table cellpadding="3" cellspacing="1">
			<tr>
				...
				<th width="200"><a href="javascript:listTable.sort('email'); "><?php echo $_smarty_tpl->tpl_vars['lang']->value['lab_email'];?>
</a><?php echo $_smarty_tpl->tpl_vars['sort_email']->value;?>
</th>
				<th width="100"><a href="javascript:listTable.sort('birthday '); "><?php echo $_smarty_tpl->tpl_vars['lang']->value['lab_birthday'];?>
</a><?php echo $_smarty_tpl->tpl_vars['sort_birthday']->value;?>
</th>
				<th width="100"><a href="javascript:listTable.sort('mobile'); "><?php echo $_smarty_tpl->tpl_vars['lang']->value['lab_mobile'];?>
</a><?php echo $_smarty_tpl->tpl_vars['sort_mobile']->value;?>
</th>
...
" />
				...
				<td align="center"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data']->value['email'], ENT_QUOTES, 'UTF-8', true);?>
</td>
				<td align="center"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data']->value['birthday'], ENT_QUOTES, 'UTF-8', true);?>
</td>
				<td align="center"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data']->value['mobile'], ENT_QUOTES, 'UTF-8', true);?>
</td>
				...
				<td align="center"><a href="../user.php?id=<?php echo $_smarty_tpl->tpl_vars['data']->value['id'];?>
" target="_blank" title="<?php echo $_smarty_tpl->tpl_vars['lang']->value['view'];?>
"><img src="templates/images/icon_view.gif" width="16" height="16" border="0" /></a> <a href="?act=edit&id=<?php echo $_smarty_tpl->tpl_vars['data']->value['id'];?>
" title="<?php echo $_smarty_tpl->tpl_vars['lang']->value['edit'];?>
"><img src="templates/images/icon_edit.gif" width="16" height="16" border="0" /></a> <a href="?act=copy&id=<?php echo $_smarty_tpl->tpl_vars['data']->value['id'];?>
" title="<?php echo $_smarty_tpl->tpl_vars['lang']->value['copy'];?>
"><img src="templates/images/icon_copy.gif" width="16" height="16" border="0" /></a> <a href="javascript:;" onclick="remove(<?php echo $_smarty_tpl->tpl_vars['data']->value['id'];?>
