<?php /* Smarty version 2.6.26, created on 2013-09-11 15:26:39
         compiled from admin_list.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'admin_list.htm', 26, false),)), $this); ?>
...
<!-- 資料搜索 -->
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "admin_search.htm", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<!-- 資料列表 -->
	...
	<div class="list-div" id="listDiv"> <?php endif; ?>		
		<table cellpadding="3" cellspacing="1">
			<tr>
				...
				<th width="250"><a href="javascript:listTable.sort('email'); "><?php echo $this->_tpl_vars['lang']['lab_email']; ?>
</a><?php echo $this->_tpl_vars['sort_email']; ?>
</th>
				<th width="150"><a href="javascript:listTable.sort('add_time'); "><?php echo $this->_tpl_vars['lang']['lab_add_time']; ?>
</a><?php echo $this->_tpl_vars['sort_add_time']; ?>
</th>
				<th width="150"><a href="javascript:listTable.sort('last_login'); "><?php echo $this->_tpl_vars['lang']['lab_last_login']; ?>
</a><?php echo $this->_tpl_vars['sort_last_login']; ?>
</th>
...
" />
				...
				<td align="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['data']['email'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
</td>
				<td align="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['data']['add_time'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
</td>
				<td align="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['data']['last_login'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
</td>
