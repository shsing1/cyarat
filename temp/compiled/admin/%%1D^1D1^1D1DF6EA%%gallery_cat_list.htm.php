<?php /* Smarty version 2.6.26, created on 2013-09-11 15:16:48
         compiled from gallery_cat_list.htm */ ?>
...
">
				<td align="left" class="first-cell" >
					<?php if ($this->_tpl_vars['cat']['img']): ?>
						<span style="float:right"><a href="<?php echo $this->_tpl_vars['cat']['original_img']; ?>
" rel="prettyPhoto"><img height="16" border="0" width="16" alt="<?php echo $this->_tpl_vars['cat']['name']; ?>
" src="templates/images/picflag.gif"/></a></span>
					<?php endif; ?>
					<?php if ($this->_tpl_vars['cat']['is_leaf'] != 1): ?>
						<img src="templates/images/menu_minus.gif" width="9" height="9" border="0" style="margin-left:<?php echo $this->_tpl_vars['cat']['depth']; ?>
em" onclick="rowClicked(this)" />
					<?php else: ?>
						<img src="templates/images/menu_arrow.gif" width="9" height="9" border="0" style="margin-left:<?php echo $this->_tpl_vars['cat']['depth']; ?>
em" />
					<?php endif; ?>
