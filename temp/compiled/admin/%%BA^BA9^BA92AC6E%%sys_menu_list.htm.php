<?php /* Smarty version 2.6.26, created on 2013-09-11 15:15:40
         compiled from sys_menu_list.htm */ ?>
	...
	<div class="list-div" id="listDiv">
		<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
			<tr>
				...
				<th width="300"><?php echo $this->_tpl_vars['lang']['lab_url']; ?>
</th>
				<th width="100"><?php echo $this->_tpl_vars['lang']['lab_is_chh']; ?>
</th>
...
em" /> <?php endif; ?> <span><?php echo $this->_tpl_vars['cat']['name']; ?>
				...
				<td><?php echo $this->_tpl_vars['cat']['url']; ?>
</td>
				<td><img src="templates/images/<?php if ($this->_tpl_vars['cat']['is_chh'] == '1'): ?>yes<?php else: ?>no<?php endif; ?>.gif" /></td>				
				<td align="center">
