...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'news_list.htm', 25, false),)), $this); ?>
...
<!-- 資料搜索 -->
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "news_search.htm", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<!-- 資料列表 -->
	...
	<div class="list-div" id="listDiv"> <?php endif; ?>		
		<table cellpadding="3" cellspacing="1">
			<tr>
				...
				<th width="100"><a href="javascript:listTable.sort('date'); "><?php echo $this->_tpl_vars['lang']['lab_date']; ?>
</a><?php echo $this->_tpl_vars['sort_date']; ?>
</th>
                <th width="50"><a href="javascript:listTable.sort('is_hot'); ">HOT</a><?php echo $this->_tpl_vars['sort_is_hot']; ?>
</th>
				...
				<th width="50" style="display:none;"><a href="javascript:listTable.sort('sort'); "><?php echo $this->_tpl_vars['lang']['lab_sort']; ?>
...
" />
				...
				<td align="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['data']['date'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
</td>
				<td align="center"><img src="templates/images/<?php if ($this->_tpl_vars['data']['is_hot']): ?>yes<?php else: ?>no<?php endif; ?>.gif" /></td>
				<td align="center"><img src="templates/images/<?php if ($this->_tpl_vars['data']['is_show']): ?>yes<?php else: ?>no<?php endif; ?>.gif" /></td>
				<td align="center" style="display:none;"><span ><?php echo $this->_tpl_vars['data']['sort']; ?>
</span></td>
				<td align="center">
...
"><img src="templates/images/icon_drop.gif" width="16" height="16" border="0" /></a></td>
			...
			<?php endforeach; else: ?>
			<tr>
				<td class="no-records" colspan="11"><?php echo $this->_tpl_vars['lang']['no_records']; ?>
</td>
			</tr>
